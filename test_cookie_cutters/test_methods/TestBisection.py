...
class TestBisection(TestCase):
    ...
    def test_calculate_bisection_precision(self):
        precision = methods.calculate_bisection_precision(3.25, 2.5)
    ...
    def test_expected_iterations(self):
        result = methods.bisect(lambda x: x**3 - 20, (0, 5), tolerance)
